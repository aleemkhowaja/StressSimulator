 ...
 *
 */
public class AtmServerConnector extends AbstractConnector<ServerBootstrap, SimulatorConfiguration>
{
     ...
     * @param reactor
     */
    public AtmServerConnector(SimulatorConfiguration serverConfig)
    {
    	super(serverConfig);
    }
	...
	bootstrap.group(getBossEventLoopGroup(), getWorkerEventLoopGroup())
		...
		.childHandler(initChannelInitialize());
	...
	Iso8583ServerChannelInitializer channelInitializer = new Iso8583ServerChannelInitializer
		(this);
