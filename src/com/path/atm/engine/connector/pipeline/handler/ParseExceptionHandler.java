...
public class ParseExceptionHandler extends ChannelInboundHandlerAdapter {
	...
	public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {
		...
		/**
		 * Whenever a parseException is caught, the connector should respond with
	...
	protected IsoMessage createErrorResponseMessage(ParseException cause) {
		...
		message.setValue(24, IsoDefinitionConstants.FUNC_ADMIN_NOT_PARSE
				, IsoType.NUMERIC, 3);
		...
		if (includeErrorDetails) {
			...
			message.setValue(IsoDefinitionConstants.BIT_ADDITIONAL_RESPONSE_DATA,
					details, IsoType.LLVAR, 25);
		}
