...
public class IsoDefinitionConstants {
	...
	/**
	 * ISO Custom Fields
	 * List of custom fields related to imal
	 */
	...
	public final static short AUTH_REQ_REPEAT = 1101; // authorization request repect
	...
	public final static short AUTH_ADVICE_REPEAT = 1121; // authorization advice repect
	public final static short AUTH_ADVICE_RESP = 1130; // authorization afvice response
	...
	public final static short FIN_ADVICE_REPEAT = 1221; // financial advice repect
	...
	public final static short FILE_REQ_REPEAT = 1305; // file action request repect
	...
	public final static short FILE_ADVICE_REPEAT = 1325; // file action advice repect
	...
	public final static short REV_ADVICE_REPEAT = 1421; // reversal advice repect
	...
	public final static short CHARGE_ADVICE_REPEAT = 1423; // chargeback advice repect
	...
	public final static short ACQ_RECON_REQ_REPEAT = 1501; // acquirer reconciliation request repect
	...
	public final static short ACQ_RECON_ADVICE_REPEAT = 1521; // acquirer reconciliation advice repect
	...
	public final static short ISSR_RECON_REQ_REPEAT = 1503; // issuer reconciliation request repect
	...
	public final static short ISSR_RECON_ADVICE_REPEAT = 1523; // issuer reconciliation advice repect
	public final static short ISSR_RECON_ADVICE_RESP = 1532; // issuer reconciliation afvice response
	...
	public final static short ADMIN_REQ_REPEAT = 1605; // administrative request repect
	...
	public final static short ADMIN_ADVICE_REPEAT = 1625; // administrative advice repect
	...
	public final static short ACQ_FEE_ADVICE_REPEAT = 1721; // acquirer fee collection advice repect
	...
	public final static short ISSR_FEE_ADVICE_REPEAT = 1723; // issuer fee collection advice repect
	...
	public final static short NET_MGMT_REQ_REPEAT = 1805; // network management request repect
	...
	public final static short NET_NGMT_ADVICE_REPEAT = 1825; // network management advice repect
	...
	public final static short RC_APPROVED_PARTIAL_SPEC = 006; // approved for partial amount; account type specified by
																// card issuer
	public final static short RC_APPROVED_ICC = 007; // approved, update ICC
	public final static short RC_APPROVED_NEED_CNFM = 80; // approved, but need confirmation(used for CIBC and NOVA debit card processing mode
	...
	public final static short RC_PICKUP_SUSPECTED_COUNTER = 210; // suspected countfeid card
	...
	public final static short RC_RECON_TOTAL_NOT_AVAILABLE = 503; // totals not avalable
	...
	public final static short RC_ADMIN_DOC_NOT_SUPP = 606; // request cannot be fulfilled-required/requested
	...
	public final static short RC_REJECT_SECURITY_ERROR_TRY_AGAIN = 920; // security software/hardware error - try again
	public final static short RC_REJECT_SECURITY_ERROR_NO_ACTION = 921; // security software/hardware error - no action
	...
	public final static short FUNC_FIN_RESUB_PREVFIN_DENY = 203; // resubmission of a previously denied financial
																	// request
	public final static short FUNC_FIN_RESUB_PREVFIN_REVER = 204; // resubmission of a previously reversed financial
																	// transaction
...
// 600-649 Used in 1604,1605,1624,1625 and 1644 messages for retrievals.
	...
	public final static short FUNC_NETWORK_BACKUP = 804; // system condition/message originator's system in backup
	...
	public final static short TPC_DB_CHEQUE_VERI = 04; // cheque verification(funds available but not quaranteed)
